"""
Django settings for bdtest_40769 project.
...
ROOT_URLCONF = 'bdtest_40769.urls'
...
WSGI_APPLICATION = 'bdtest_40769.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bdtest_40769 API",
    "DESCRIPTION": "API documentation for bdtest_40769 App",
    "VERSION": "v1",
}
